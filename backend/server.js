...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/schemescout';
...
app.get('/health', (req, res) => {
  res.status(200).json({
    success: true,
    message: 'SchemeScout API is running',
...
async function startServer() {
  try {
    ...
    app.listen(PORT, () => {
      console.log(`🚀 SchemeScout API running on http://localhost:${PORT}`);
