  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        {/* AI Match Reason — expandable */}
        {matchReason && (
          <div className="mb-4">
            <button
              onClick={() => setReasonOpen((v) => !v)}
              className="w-full flex items-center justify-between gap-2 px-3 py-2 rounded-xl bg-indigo-50 border border-indigo-100 text-indigo-700 text-xs font-semibold hover:bg-indigo-100 transition-colors"
            >
            ...
            <AnimatePresence>
              {reasonOpen && (
                ...
                >
                  <p className="mt-2 px-3 py-2.5 text-xs text-indigo-800 bg-indigo-50/60 rounded-xl leading-relaxed border border-indigo-100">
                    {matchReason}
                  </p>
                </motion.div>
              )}
