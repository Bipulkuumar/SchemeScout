            ...
            <div className="flex-1">
              ...
              {!loading && (
                <div className="flex flex-wrap items-center gap-2 mt-1 mb-1">
                  {aiPowered && (
                    <div className="inline-flex items-center gap-1.5 py-1 px-3 rounded-full bg-indigo-600 text-white text-xs font-bold tracking-wide shadow-md shadow-indigo-400/30">
                  ...
                  {fromCache && (
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 py-1 px-3 rounded-full bg-slate-100 text-slate-500 text-xs font-semibold hover:bg-slate-200 transition-colors border border-slate-200"
                    >
